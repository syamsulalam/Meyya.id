...
export const developmentRoadmap: RoadmapItem[] = [
  ...
  { title: 'Voucher birthday otomatis', status: 'planned', area: 'Marketing', note: 'Butuh aturan nominal, periode klaim, dan anti penyalahgunaan.' },
  ...
  { title: 'Normalisasi stok global dari varian', status: 'planned', area: 'Operations', note: 'Stok produk utama sebaiknya dihitung dari total varian aktif.' },
