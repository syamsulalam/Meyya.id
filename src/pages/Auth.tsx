...
export default function Auth() {
  ...
  const commonAppearance = {
    elements: {
      ...
      formButtonPrimary: "px-6 py-3 bg-ink text-white rounded-full uppercase tracking-[0.2em] text-xs hover:bg-black/80 transition-colors w-full mt-2 font-medium shadow-none border-none outline-none focus:ring-2 focus:ring-ink/20",
      formFieldInput: "w-full bg-white/50 border border-black/10 rounded-full py-3 px-6 focus:outline-none focus:border-black/50 transition-colors font-sans text-ink text-sm",
      formFieldLabel: "text-xs font-medium text-gray-700 ml-2 mb-1",
