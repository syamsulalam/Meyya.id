...
export default function Auth() {
  ...
  const handleGoogleLogin = async () => {
     if (!isSignInLoaded || !signIn) {
       setErrorMsg('Koneksi Oauth Google Clerk terblokir. Gunakan Bypass atau izinkan third-party cookie di browser.');
       return;
     }
          ...
          <>
            ...
            <form className="space-y-5" onSubmit={handleClerkAuth}>
              ...
              <button 
                type="submit" 
                disabled={isLoading} 
                className="px-6 py-3 bg-ink text-white rounded-full uppercase tracking-[0.2em] text-xs hover:bg-black/80 transition-colors w-full mt-4 disabled:opacity-50"
              >
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 bg-white border border-black/10 py-3 px-6 rounded-full hover:bg-black/5 transition-colors mb-8 disabled:opacity-50"
            >
