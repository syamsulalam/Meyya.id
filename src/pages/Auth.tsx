  ...
  return (
    <div className="max-w-md mx-auto px-4 py-16 w-full flex-1 flex flex-col justify-center">
      <div className="glass-panel p-8 md:p-12 rounded-[40px] w-full">
        ...
        <form className="space-y-5" onSubmit={(e) => handleAuth(e, 'customer')}>
          {activeTab === 'register' && (
            <>
              <div>
                <input 
          ...
          <button type="submit" className="px-6 py-3 bg-ink text-white rounded-full uppercase tracking-[0.2em] text-xs hover:bg-black/80 transition-colors w-full mt-4">
        ...
        <button type="button" onClick={(e) => handleAuth(e as any, 'customer')} className="w-full flex items-center justify-center gap-3 bg-white border border-black/10 py-3 px-6 rounded-full hover:bg-black/5 transition-colors mb-8">
        ...
        <div className="pt-6 border-t border-black/10">
          <p className="text-xs uppercase tracking-widest text-center opacity-40 mb-4">Mode Simulasi (Testing)</p>
          <div className="flex gap-2">
            <button onClick={(e) => handleAuth(e as any, 'customer')} className="flex-1 py-2 rounded-full border border-black/10 text-xs hover:bg-black/5 transition-colors">
              Masuk sbg Pelanggan
            </button>
            <button onClick={(e) => handleAuth(e as any, 'admin')} className="flex-1 py-2 rounded-full border border-black/10 text-xs hover:bg-black/5 transition-colors">
              Masuk sbg Admin
            </button>
          </div>
        </div>
